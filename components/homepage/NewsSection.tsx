            ...
            >
              ...
              <div className="relative p-8 z-10">
                ...
                <div className="flex items-center gap-3 mb-4">
                  <span className={`glass px-4 py-1.5 rounded-full text-xs font-semibold border border-white/20 bg-gradient-to-r ${item.gradient} bg-clip-text text-transparent`}>
                    {item.category}
                  </span>
